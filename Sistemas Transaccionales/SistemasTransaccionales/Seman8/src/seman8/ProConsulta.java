 ...
 * @author andre
 */
public class ProConsulta extends javax.swing.JPanel {

    /**
     * Creates new form ProConsulta
     */
    public ProConsulta() {
        initComponents();
        ...
        try(PreparedStatement stmt = conectarp.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                registros[2] = rs.getInt("cantidad_en_inventario")+"";
                registros[3]= rs.getDouble("precio_venta") + "";
                registros[4] = rs.getInt("productoActivo")==1?"Activo":"Borrado";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenido al Modulo para consulta productos");
